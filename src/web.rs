  ...
  <main>
    ...
    <section class="panel claim-panel">
      <div class="panel-heading">
        ...
        <p class="hint">The tag must report a TID and be visible to the reader within the claim window.</p>
      </div>
